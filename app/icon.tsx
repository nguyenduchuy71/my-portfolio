...
/** Favicon — palm knocked out of the husk-brown field. */
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        <svg viewBox="0 0 40 32" width="56" height="45"
      fill="none"
    ...
    >
      ...
      <circle cx="19.6" cy="13.4" r="1.6" fill="#faf6ef" />
      <circle cx="23.2" cy="13.9" r="1.35" fill="#faf6ef" opacity="0.72" />

      {/* Ground line — the waterline the palm leans over */}
      <path d="M12 30.4 H28" stroke="#faf6ef" strokeWidth="1.2" opacity="0.35" />
    </svg>
      </div>
    ),
    size,
